...
#     # Asegúrate de que haya al menos un archivo
#     if not nc_files:
#         raise ValueError("No se encontró ningún archivo NetCDF en el directorio")

#     # Abre el primer dataset disponible
#     ds1 = xr.open_dataset(nc_files[0])

#     # Crea la figura interactiva usando Plotly
#     fig = go.Figure()

#     # Gráfico (100-m resolution)
#     fig.add_trace(go.Heatmap(
#         x=ds1.time, 
#         y=ds1['height'][0,:], 
#         z=ds1['attenuated_radar_reflectivity'].T, 
