...
//             que interpretamos y respondemos al cambio climático. Con un
...
function AboutUs() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-poppins">
      <Header /> {/* Usar el nuevo componente Header */}
      <section className="flex flex-col md:flex-row p-8 bg-gray-100 text-gray-800 items-center justify-center">
        {/* Contenido principal */}
        <div className="md:w-2/4 p-4 space-y-6 text-center">
          <h1
            className="text-4xl font-bold mb-4"
            data-aos="fade-up"
            data-aos-duration="1000"
        ...
        {/* Espacio lateral derecho - Mover las fotos aquí */}
        <div className="md:w-1/4 p-20 space-y-4 mb-40 mt-10">
          <div className="text-center">
            <img
              src="/app/foto-felipe.png"
              alt="Felipe Coliman"
