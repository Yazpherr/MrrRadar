...
function Header() {
  ...
  // Determinar qué logo mostrar basado en la ubicación actual
  const logoSrc = location.pathname === "/app/" 
    ? "/app/uoh-logo-header.png" // Logo para la página principal
    : "/app/logo-alfanova.png";  // Logo para otras páginas

  return (
    <header className="relative border-b border-gray-300 w-full p-4 flex justify-between items-center z-10">
      <div className="flex items-center">
        <img
          src={logoSrc} // Usar logoSrc determinado por la ruta
          alt="AlphaNova Logo"
          className="h-12 w-auto pl-4" // Aumentar a h-12 para mayor visibilidad
        />
